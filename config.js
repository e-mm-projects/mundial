...
const lastNames = ['Mišun', 'Svoboda', 'Novotný', 'Dvořák', 'Černý', 'Procházka', 'Kučera', 'Veselý', 'Horák', 'Kužel', 'Němec', 'Pokorný', 'Stanovský', 'Vlasák', 'Machala', 'Pavelka', 'Suchán', 'Pala', 'Vašina', 'Mikala', 'Bakalík'];
